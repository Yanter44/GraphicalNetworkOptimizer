...
namespace NetOptimizer.ViewModels.DeviceSettingss
{
    public class SwitchSettingViewModel : DeviceSettingsBase, INotifyPropertyChanged
    {
        ...
        public int PoeBudgetW => SelectedModelFromCatalog?.PoeBudgetW ?? 0;
        public decimal ThroughputGbps => SelectedModelFromCatalog?.ThroughputGbps ?? 0;
        public int MacTableSize => SelectedModelFromCatalog?.MacTableSize ?? 0;
        public int MaxVlans => SelectedModelFromCatalog?.MaxVlans ?? 0;
        ...
        public bool SupportsPoe => SelectedModelFromCatalog?.SupportsPoe ?? false;
        ...
        public SwitchSettings GetSettings()
        {
            ...
            return new SwitchSettings
            {
                ...
                SupportsPoe = this.SupportsPoe,
                AveragePrice = this.AveragePrice,
                DeviceLayer = this.DeviceLayer,
